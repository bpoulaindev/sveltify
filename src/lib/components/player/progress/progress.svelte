...
<div class="flex flex-col lg:flex-col-reverse {classes}">
  <span use:melt={$root}
        role="slider"
        ...
        class="relative flex h-1 w-full group cursor-pointer items-center">
    ...
    <div class="flex items-center w-full justify-between mt-0.5 mb-0 lg:mb-0.5 lg:mt-0">
