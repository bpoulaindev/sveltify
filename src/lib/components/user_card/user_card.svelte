...
{:else}
    <div class="{classes} flex min-w-fit sm:w-fit w-full overflow-hidden items-center px-2 h-14 rounded-2xl bg-white dark:bg-zinc-900 border-2 border-zinc-200 dark:border-zinc-700">
